...
class BearerTokenFilter extends HttpFilter {
    ...
    public BearerTokenFilter(JwtService jwtService, AuthenticationFailureHandler failureHandler) {
    ...
    protected void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (authorizationHeader == null || authorizationHeader.isEmpty()) {
            ...
            try {
                ...
                JwtAuthenticationException authException = new JwtAuthenticationException("Invalid token. Bearer token could not be parsed");
                logger.debug(e.getMessage());
